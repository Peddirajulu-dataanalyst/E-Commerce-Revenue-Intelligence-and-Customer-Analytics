...
def run_feature_engineering():
    ...
    orders.to_csv(os.path.join(CLEAN_PATH, "clean_orders.csv"), index=False)
    customers.to_csv(os.path.join(CLEAN_PATH, "clean_customers.csv"), index=False)
    products.to_csv(os.path.join(CLEAN_PATH, "clean_products.csv"), index=False)
    returns.to_csv(os.path.join(CLEAN_PATH, "clean_returns.csv"), index=False)
    rfm.to_csv(os.path.join(CLEAN_PATH, "rfm_summary.csv"), index=False)
